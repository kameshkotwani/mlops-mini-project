...
def main():
    try:
        ...
        train_data = load_data(INTERIM_DATA_DIR / 'train_processed.csv')
        test_data = load_data(INTERIM_DATA_DIR / 'test_processed.csv')

        train_df, test_df = apply_bow(train_data, test_data, max_features)

        save_data(train_df, PROCESSED_DATA_DIR / "train_bow.csv")
        save_data(test_df,PROCESSED_DATA_DIR /"test_bow.csv")
    except Exception as e:
